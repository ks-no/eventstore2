...
class SagaMongoDBRepositoryTest extends MongoDbEventstore2TestKit {
    ...
    @Test
    void testStateUpdateGenerateOneDocument() throws Exception {
    ...
    @Test
    void testTwoSaves() throws Exception {
    ...
    @Test
    void testNullValueInGetState() throws Exception {
        assertEquals((byte)0, repo.getState("FormProcess", "NotValidSagaID"));
    }

    @Test
    void testSaveLatestJournalId() throws Exception {
    ...
    @Test
    void awakeInFutureDosentTrigger() {
